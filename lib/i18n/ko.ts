const ko = {
  ...
  "tasks.content": "설명",
  "tasks.contentPlaceholder": "이 태스크에 대한 설명을 적어주세요",
  "tasks.noContent": "설명이 없습니다",
  "tasks.schedule": "일정",
  "tasks.status": "상태",
  "tasks.output": "결과물",
  ...
  "tasks.addChecklistItem": "할일 추가",
  "tasks.checklistPlaceholder": "이걸 끝내기 위한 세부 할일",
  "tasks.priority": "우선순위",
  "tasks.dueDate": "마감일",
  "tasks.assignee": "담당자",
  ...
  "tasks.completeMainConfirm": "아직 미완료 서브태스크가 {n}건 있어요. 메인 태스크를 완료 처리할까요? (하위 {total}건이 모두 완료로 바뀝니다)",
  "tasks.completeMainTitle": "메인 태스크 완료",
  "tasks.completeMainAction": "모두 완료 처리",
  ...
  "tasks.detail": "태스크 정보",
  "tasks.edited": "태스크 편집",
  "tasks.noOutput": "등록된 결과물이 없습니다",
  "tasks.noDate": "기간이 설정되지 않았습니다",
  "tasks.noAssignee": "담당자가 없습니다",
  "tasks.noChecklist": "세부 할일이 없습니다",
  "tasks.priorityLow": "낮음",
  "tasks.priorityMedium": "보통",
  "tasks.priorityHigh": "높음",
  "tasks.overview": "개요",
  "tasks.addAssignee": "담당자 추가",
  "tasks.autoFromSubs": "자동 집계",
  "tasks.progressAuto": "서브태스크 완료도 기준으로 자동 계산됩니다",
  "tasks.progressDone": "완료 처리되어 100%입니다",
  // 타임라인 매트릭스
  "matrix.tbd": "미정",
  "matrix.total": "전체",
  ...
  "dashboard.cases": "건",
  "dashboard.noUrgent": "없음",
  "dashboard.teamDeadlines": "팀 마감 현황",
  "dashboard.overdue": "지연",
  "dashboard.dueSoon": "마감 임박",
  "dashboard.dueLater": "예정",
  "dashboard.dDay": "오늘 마감",
  "dashboard.daysOverdue": "일 지연",
  "dashboard.noOwner": "담당 미정",
  "dashboard.noDeadlineTasks": "마감 임박·지연 태스크가 없어요",
  "dashboard.showAllDeadlines": "예정 포함 전체 보기",
  "dashboard.showUrgentOnly": "임박·지연만 보기",

        ...
        >
          ...
          <div className="mt-3 space-y-0.5 px-5">
            <div className="flex items-center gap-2.5 py-1.5 text-[13px]">
              ...
              <span className="text-gray-700">임직원 {company.memberCount}명</span>
            </div>
            ...
            {company.foundedAt && (
              <div className="flex items-center gap-2.5 py-1.5 text-[13px]">
                ...
                <span className="text-blue-500">{daysSince(company.foundedAt).toLocaleString()}일째</span>
              </div>
            )}
            ...
            {company.businessNumber && (
              <div className="flex items-center gap-2.5 py-1.5 text-[13px]">
                ...
                <CopyButton value={company.businessNumber} />
              </div>
            )}
            ...
            {company.corpNumber && (
              <div className="flex items-center gap-2.5 py-1.5 text-[13px]">
                ...
                <span className="text-gray-400">법인번호</span>
                <span className="text-gray-900">{company.corpNumber}</span>
                <CopyButton value={company.corpNumber} />
              </div>
            )}
            ...
            {company.phone && (
              <div className="flex items-center gap-2.5 py-1.5 text-[13px]">
                ...
                <CopyButton value={company.phone} />
              </div>
            )}
            ...
            {company.address && (
              <div className="flex items-center gap-2.5 py-1.5 text-[13px]">
                ...
                <CopyButton value={company.address} />
              </div>
            )}
          </div>
        </div>,

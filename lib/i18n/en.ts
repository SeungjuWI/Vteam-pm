...
const en: Record<TranslationKey, string> = {
  ...
  "tasks.completeMainConfirm": "There are still {n} incomplete subtasks. Complete this main task? (all {total} subtasks will be marked done)",
  "tasks.completeMainTitle": "Complete main task",
  "tasks.completeMainAction": "Complete all",
  ...
  "tasks.edited": "Edit task",
  "tasks.noOutput": "No output added yet",
  "tasks.noDate": "No timeline set",
  "tasks.noAssignee": "No assignee",
  "tasks.noChecklist": "No subtasks yet",
  "tasks.priorityLow": "Low",
  "tasks.priorityMedium": "Medium",
  "tasks.priorityHigh": "High",
  "tasks.overview": "Overview",
  "tasks.addAssignee": "Add assignee",
  "tasks.autoFromSubs": "Auto",
  "tasks.progressAuto": "Calculated automatically from subtask completion",
  "tasks.progressDone": "Marked complete — 100%",
  // Timeline matrix
  "matrix.tbd": "TBD",
  "matrix.total": "Total",

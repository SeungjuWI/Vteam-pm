    ...
    <div>
      ...
      {visible.length === 0 ? (
        <div className="flex flex-col items-center gap-2 rounded-xl bg-white py-12">
          ...
          <p className="text-sm text-gray-400">{t("okr.empty")}</p>
        </div>
      ) : (
                ...
                <div className="mt-4 flex flex-col gap-3 border-t border-gray-50 pt-4">
                  ...
                  {addingKrFor === o.id ? (
                    <div className="flex items-center gap-2">
                      ...
                      />
                      <button onClick={() => handleAddKr(o.id)} className="rounded-lg bg-blue-500 px-3 py-1.5 text-xs font-medium text-white hover:bg-blue-600">
                        {t("common.add")}
                      </button>
                    </div>
                  ) : (

...
function CopyButton({ value, label }: { value: string; label: string }) {
  ...
  return (
    <button
      onClick={handleCopy}
      className="ml-auto flex-shrink-0 pl-2 text-gray-300 transition-colors hover:text-gray-500 active:scale-[0.95]"
      title={label}
    >
      {copied ? (
          ...
          <div className="mt-3 space-y-0.5 px-5">
            ...
            {company.foundedAt && (
              <div className="flex items-center gap-2.5 py-1.5 text-[13px]">
                ...
                <span className="text-gray-600">{t("companyChip.founded")}</span>
            ...
            {company.businessNumber && (
              <div className="flex items-center gap-2.5 py-1.5 text-[13px]">
                ...
                <span className="text-gray-600">{t("company.businessNumber")}</span>
            ...
            {company.corpNumber && (
              <div className="flex items-center gap-2.5 py-1.5 text-[13px]">
                ...
                <span className="text-gray-600">{t("company.corpNumber")}</span>

      ...
      <div className="rounded-xl bg-white p-6">
        ...
        <div className="rounded-lg border border-gray-200 px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <button
              disabled
              className="rounded-lg bg-gray-100 px-4 py-2 text-sm font-semibold text-gray-400 shadow-soft-xs transition-all duration-200 ease-spring active:scale-[0.98]"
            >
